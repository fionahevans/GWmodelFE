...
# FE
box.wt.vec <- function(vdist, bw) {
  as.vector(box_wt_vec(vdist, bw))
}

box.wt.vec.ad <- function(vdist, bw) {
  as.vector(box_wt_vec_ad(vdist, bw))
}

gau.wt.vec.ad <- function(vdist, bw) {
  as.vector(gau_wt_vec_ad(vdist, bw))
}

bis.wt.vec.ad <- function(vdist, bw) {
  as.vector(bis_wt_vec_ad(vdist, bw))
}

tri.wt.vec.ad <- function(vdist, bw) {
  as.vector(tri_wt_vec_ad(vdist, bw))
}

exp.wt.vec.ad <- function(vdist, bw) {
  as.vector(exp_wt_vec_ad(vdist, bw))
}
